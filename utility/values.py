...
wpawn_anarchy = ChessItem(
    ...
    internal_emoji = "<:Wpawnanarchy:971046978349858936>",
    is_white = True,
    gambit_bonus = 900,
...
wknight_anarchy = ChessItem(
    ...
    internal_emoji = "<:Wknightanarchy:971046961811714158>",
    is_white = True,
    gambit_bonus = 900,
    attributes = ["anarchy_piece", "white_anarchy_piece", "rollable"],
...
wbishop_anarchy = ChessItem(
    ...
    internal_emoji = "<:Wbishopanarchy:971046928395665448>",
    is_white = True,
    gambit_bonus = 900,
    attributes = ["anarchy_piece", "white_anarchy_piece", "rollable"],
...
wrook_anarchy = ChessItem(
    ...
    internal_emoji = "<:Wrookanarchy:971047003402403862>",
    is_white = True,
    gambit_bonus = 900,
    attributes = ["anarchy_piece", "white_anarchy_piece", "rollable"],
...
wqueen_anarchy = ChessItem(
    ...
    internal_emoji = "<:Wqueenanarchy:971046990312013844>",
    is_white = True,
    gambit_bonus = 900,
    attributes = ["anarchy_piece", "white_anarchy_piece", "rollable"],
...
wking_anarchy = ChessItem(
    ...
    internal_emoji = "<:Wkinganarchy:971046942144602172>",
    is_white = True,
    gambit_bonus = 900,
    attributes = ["anarchy_piece", "white_anarchy_piece", "rollable"],
